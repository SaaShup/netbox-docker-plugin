    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                ...
                models.F("type"),
                models.F("container"),
                name="netbox_docker_port_unique_private_port_public_port_type_container'",
            ),
        ),
        migrations.AddConstraint(
            model_name="mount",
            constraint=models.UniqueConstraint(
                fields=("volume",), name="netbox_docker_mount_unique_volume"
            ),
        ),
        migrations.AddConstraint(
            model_name="label",
            constraint=models.UniqueConstraint(
                models.F("key"),
                models.F("container"),
                name="netbox_docker_label_unique_key_container'",
            ),
        ),
        migrations.AddConstraint(
            model_name="env",
            constraint=models.UniqueConstraint(
                models.F("var_name"),
                models.F("container"),
                name="netbox_docker_env_unique_var_name_container'",
            ),
        ),
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                ...
                models.F("host"),
                name="netbox_docker_container_unique_name_host'",
            ),
        ),
    ]
